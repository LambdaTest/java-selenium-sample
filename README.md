...
- Follow the [TestMu AI Documentation](https://www.testmuai.com/support/docs/java-with-selenium-running-java-automation-scripts-on-testmu-selenium-grid/) for the full setup walkthrough.
